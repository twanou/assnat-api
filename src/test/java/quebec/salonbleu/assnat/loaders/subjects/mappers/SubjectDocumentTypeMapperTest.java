                ...
                .children(List.of(ScrapedLogNode.builder()
                        ...
                        .children(List.of(
                                ScrapedLogNode.builder()
                                        ...
                                        .paragraphs(List.of("M. Bouchard : Bonjour", "• (10 h 20) •", "oui", "Vice-Président : merci lulu", "bon passons à autre chose"))
                                        .build(),
                                ScrapedLogNode.builder()
        ...
        SubjectDetails expectedResult = SubjectDetails.builder()
                ...
                .interventions(List.of(
                        InterventionDocument.builder()
                                ...
                                .paragraphs(List.of("Bonjour", "oui", "Vice-Président : merci lulu", "bon passons à autre chose"))
                                .build()))
                .build();
