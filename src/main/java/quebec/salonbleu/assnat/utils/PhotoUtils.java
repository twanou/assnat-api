...
public class PhotoUtils {
    ...
    public String getUniqueId(String firstName, String lastName, String lastDistrict) {
        String hexString = DigestUtils.sha256Hex(FILE_NAME_FORMAT.formatted(firstName, lastName, lastDistrict));
        return new BigInteger(hexString, 16).toString(36);
    }

    public String getPhotoUrl(String firstName, String lastName, String lastDistrict) {
        String id = this.getUniqueId(firstName, lastName, lastDistrict);
